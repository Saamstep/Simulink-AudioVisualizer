...
MAKECMD         = /Applications/MATLAB_R2024b.app/bin/maca64/gmake -j 14 -l 14
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = bucket_fft
MODULES                 = DAHostLib_rtw.c HostLib_MMFile.c HostLib_Multimedia.c HostLib_Audio.c HostLib_FFT.c bucket_fft.c bucket_fft_capi.c bucket_fft_data.c bucket_fft_tgtconn.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = bucket_fft
MAKEFILE                = bucket_fft.mk
MATLAB_ROOT             = /Applications/MATLAB_R2024b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2024b.app
START_DIR               = /Users/samstep/Documents/MATLAB/503/Final\ Project
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 0
COMPUTER                = MACA64
...
ADD_INCLUDES = \
	...
	-I$(MATLAB_ROOT)/toolbox/dsp/dsp/include \
	-I$(START_DIR)/slprj/raccel/bucket_fft \
	...
	-I$(MATLAB_ROOT)/toolbox/dsp/dsp/extern/src/export/include/src \
	-I$(MATLAB_ROOT)/toolbox/dsp/dsp/extern/src/export/include \
...
%.o : $(MATLAB_ROOT)/extern/include/multimedia/%.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"

%.o : $(MATLAB_ROOT)/toolbox/dsp/dsp/include/%.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
DAHostLib_rtw.o : $(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/src/DAHostLib_rtw.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/toolbox/shared/spc/src_ml/extern/src/DAHostLib_rtw.c

HostLib_MMFile.o : $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/HostLib_MMFile.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/HostLib_MMFile.c

HostLib_Multimedia.o : $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/HostLib_Multimedia.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/HostLib_Multimedia.c

HostLib_Audio.o : $(MATLAB_ROOT)/toolbox/dsp/dsp/include/HostLib_Audio.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/toolbox/dsp/dsp/include/HostLib_Audio.c

HostLib_FFT.o : $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/HostLib_FFT.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include/HostLib_FFT.c
...
%.o : $(MATLAB_ROOT)/extern/include/multimedia/%.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"

%.o : $(MATLAB_ROOT)/toolbox/dsp/dsp/include/%.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
